    ...
    <Card style="width:96%; left: 2%;">
        ...
        <div class="demo-split">
            <Split v-model="split1">
                ...
                <template #right>
                    <Paragraph style="margin-left: 80px; margin-top:70px;">
                        ...
                        <Text strong> problems out of </Text>
                        <CountUp :end="totalQuestions" :duration="10" ref="count" v-font="24" style="color: blueviolet;" />
                        <Text strong> problems!</Text>
                        <br>
                    </Paragraph>
                </template>
            </Split>
